...
<template>
  <view class="page">
    <wd-navbar title="导播台" safe-area-inset-top fixed placeholder />
        ...
        <view class="current-robot-card">
          ...
          <template v-else>
            <view class="empty-box">
              <text class="empty-text">暂无机器人</text>
              <view class="current-switch" @click="showRobotPopup = true">
                查看列表
              </view>
            </view>
            ...
            <view class="plan-row">
              <picker mode="selector" :range="planPickerRange" :value="selectedPlanIndex < 0 ? 0 : selectedPlanIndex" @change="handlePlanChange">
                <view class="plan-selector">
                  <text class="plan-selector__label">导播方案</text>
                  <text class="plan-selector__value">{{ selectedPlanLabel }}</text>
                </view>
              </picker>
          ...
          <view class="message-card">
            <view class="message-header">
              ...
              <view class="viewer-wrap">
                <text class="viewer-label">在线人数</text>
                <text class="viewer-value">{{ currentViewerCountText }}</text>
              </view>
            </view>
    ...
    <view v-if="showRobotPopup" class="robot-popup-mask" @click="showRobotPopup = false">
      <view class="robot-popup" @click.stop>
        <view class="robot-popup__header">
          <text class="robot-popup__title">选择机器人</text>
          <text class="robot-popup__close" @click="showRobotPopup = false">×</text>
        </view>
